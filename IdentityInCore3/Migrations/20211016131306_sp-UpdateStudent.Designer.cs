...
namespace IdentityInCore3.DAL.Migrations
{
    ...
    [Migration("20211016131306_sp-UpdateStudent")]
    partial class spUpdateStudent
    {
            ...
            modelBuilder.Entity("IdentityInCore3.DAL.Models.SubjectMaster", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 10, 16, 13, 13, 5, 943, DateTimeKind.Unspecified).AddTicks(8115), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Math"
                        },
                        new
                        {
                            Id = 2L,
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 10, 16, 13, 13, 5, 943, DateTimeKind.Unspecified).AddTicks(8721), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Hindi"
                        },
                        new
                        {
                            Id = 3L,
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 10, 16, 13, 13, 5, 943, DateTimeKind.Unspecified).AddTicks(8731), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "EVS"
                        },
                        new
                        {
                            Id = 4L,
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 10, 16, 13, 13, 5, 943, DateTimeKind.Unspecified).AddTicks(8734), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "English"
                        });
                });
