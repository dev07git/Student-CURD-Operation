...
namespace IdentityInCore3.DAL.Migrations
{
    ...
    [Migration("20211016130346_InitialMigration")]
            ...
            modelBuilder.Entity("IdentityInCore3.DAL.Models.SubjectMaster", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 10, 16, 13, 3, 46, 27, DateTimeKind.Unspecified).AddTicks(4693), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Math"
                        },
                        new
                        {
                            Id = 2L,
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 10, 16, 13, 3, 46, 27, DateTimeKind.Unspecified).AddTicks(5292), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Hindi"
                        },
                        new
                        {
                            Id = 3L,
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 10, 16, 13, 3, 46, 27, DateTimeKind.Unspecified).AddTicks(5301), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "EVS"
                        },
                        new
                        {
                            Id = 4L,
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 10, 16, 13, 3, 46, 27, DateTimeKind.Unspecified).AddTicks(5304), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "English"
                        });
                });
